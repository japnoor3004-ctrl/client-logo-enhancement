...
INSERT INTO public.site_stats (label, value, suffix, published, sort_order) VALUES
  ('Years of Excellence', EXTRACT(YEAR FROM now())::int - 2001, '+', true, 1),
  ('Group Companies', 11, '', true, 2),
  ('Countries', 5, '', true, 3),
  ('Employees', 1000, '+', true, 4);
