...
import smelterHeroDomesSrc__ptr from "@/assets/smelter-hero-domes.jpg.asset.json";
const smelterHeroDomesSrc = smelterHeroDomesSrc__ptr.url;
const smelterHeroDomesAsset = { url: smelterHeroDomesSrc };
import smelterDomeLiftSrc__ptr from "@/assets/smelter-dome-lift.jpg.asset.json";
const smelterDomeLiftSrc = smelterDomeLiftSrc__ptr.url;
const smelterDomeLiftAsset = { url: smelterDomeLiftSrc };
import tankDomesAerialSrc__ptr from "@/assets/tank-domes-aerial.jpg.asset.json";
const tankDomesAerialSrc = tankDomesAerialSrc__ptr.url;
const tankDomesAerialAsset = { url: tankDomesAerialSrc };
import valeASrc__ptr from "@/assets/vale-a.jpg.asset.json";
const valeASrc = valeASrc__ptr.url;
const valeAAsset = { url: valeASrc };
import valeBSrc__ptr from "@/assets/vale-b.jpg.asset.json";
const valeBSrc = valeBSrc__ptr.url;
const valeBAsset = { url: valeBSrc };
import valeCSrc__ptr from "@/assets/vale-c.jpg.asset.json";
const valeCSrc = valeCSrc__ptr.url;
const valeCAsset = { url: valeCSrc };
import valeFSrc__ptr from "@/assets/vale-f.jpg.asset.json";
const valeFSrc = valeFSrc__ptr.url;
const valeFAsset = { url: valeFSrc };
import yibalKilnSrc__ptr from "@/assets/yibal-kiln.jpg.asset.json";
const yibalKilnSrc = yibalKilnSrc__ptr.url;
const yibalKilnAsset = { url: yibalKilnSrc };
import barkaRack1Src__ptr from "@/assets/barka-swro-rack1.jpg.asset.json";
const barkaRack1Src = barkaRack1Src__ptr.url;
const barkaRack1Asset = { url: barkaRack1Src };
import barkaRack2Src__ptr from "@/assets/barka-swro-rack2.jpg.asset.json";
const barkaRack2Src = barkaRack2Src__ptr.url;
const barkaRack2Asset = { url: barkaRack2Src };
import barkaRack3Src__ptr from "@/assets/barka-swro-rack3.jpg.asset.json";
const barkaRack3Src = barkaRack3Src__ptr.url;
const barkaRack3Asset = { url: barkaRack3Src };
import duqmEpc1ProcessImg__ptr from "@/assets/duqm-epc1-process-units.jpg.asset.json";
const duqmEpc1ProcessImg = duqmEpc1ProcessImg__ptr.url;
import duqmEpc1SteelImg__ptr from "@/assets/duqm-epc1-steel-structure.jpg.asset.json";
const duqmEpc1SteelImg = duqmEpc1SteelImg__ptr.url;
import duqmEpc1PiperackImg__ptr from "@/assets/duqm-epc1-piperack.jpg.asset.json";
const duqmEpc1PiperackImg = duqmEpc1PiperackImg__ptr.url;
import duqmEpc1PiperackWideImg__ptr from "@/assets/duqm-epc1-piperack-wide.jpg.asset.json";
const duqmEpc1PiperackWideImg = duqmEpc1PiperackWideImg__ptr.url;
import duqmEpc1SwitchgearImg__ptr from "@/assets/duqm-epc1-switchgear.jpg.asset.json";
const duqmEpc1SwitchgearImg = duqmEpc1SwitchgearImg__ptr.url;
import duqmEpc2OffsitesImg__ptr from "@/assets/duqm-epc2-offsites.jpg.asset.json";
const duqmEpc2OffsitesImg = duqmEpc2OffsitesImg__ptr.url;
import duqmEpc2DerrickImg__ptr from "@/assets/duqm-epc2-derrick.jpg.asset.json";
const duqmEpc2DerrickImg = duqmEpc2DerrickImg__ptr.url;
import duqmEpc2BulletLiftImg__ptr from "@/assets/duqm-epc2-bullet-lift.jpg.asset.json";
const duqmEpc2BulletLiftImg = duqmEpc2BulletLiftImg__ptr.url;
import duqmEpc2BulletTransportImg__ptr from "@/assets/duqm-epc2-bullet-transport.jpg.asset.json";
const duqmEpc2BulletTransportImg = duqmEpc2BulletTransportImg__ptr.url;
import duqmEpc2PiperackRoadImg__ptr from "@/assets/duqm-epc2-piperack-road.jpg.asset.json";
const duqmEpc2PiperackRoadImg = duqmEpc2PiperackRoadImg__ptr.url;
import duqmEpc2SwitchgearImg__ptr from "@/assets/duqm-epc2-switchgear.jpg.asset.json";
const duqmEpc2SwitchgearImg = duqmEpc2SwitchgearImg__ptr.url;
import telcoNedcBuildingImg__ptr from "@/assets/telco-nedc-substation-building.jpg.asset.json";
const telcoNedcBuildingImg = telcoNedcBuildingImg__ptr.url;
import telcoNedcTransformerBayImg__ptr from "@/assets/telco-nedc-transformer-bay.jpg.asset.json";
const telcoNedcTransformerBayImg = telcoNedcTransformerBayImg__ptr.url;
import telcoNedc33kvImg__ptr from "@/assets/telco-nedc-33kv-switchgear.jpg.asset.json";
const telcoNedc33kvImg = telcoNedc33kvImg__ptr.url;
import telcoNedc11kvImg__ptr from "@/assets/telco-nedc-11kv-switchgear.jpg.asset.json";
const telcoNedc11kvImg = telcoNedc11kvImg__ptr.url;
import telcoNedcRelayPanelsImg__ptr from "@/assets/telco-nedc-control-relay-panels.jpg.asset.json";
const telcoNedcRelayPanelsImg = telcoNedcRelayPanelsImg__ptr.url;
import telcoNedcBatteryImg__ptr from "@/assets/telco-nedc-battery-bank.jpg.asset.json";
const telcoNedcBatteryImg = telcoNedcBatteryImg__ptr.url;
import telcoMarafiqLiftImg__ptr from "@/assets/telco-marafiq-transformer-lift.jpg.asset.json";
const telcoMarafiqLiftImg = telcoMarafiqLiftImg__ptr.url;
import telcoMarafiqDeliveryImg__ptr from "@/assets/telco-marafiq-transformer-delivery.jpg.asset.json";
const telcoMarafiqDeliveryImg = telcoMarafiqDeliveryImg__ptr.url;
import telcoMarafiqGlandingImg__ptr from "@/assets/telco-marafiq-cable-glanding.jpg.asset.json";
const telcoMarafiqGlandingImg = telcoMarafiqGlandingImg__ptr.url;
import telcoMarafiqRelayImg__ptr from "@/assets/telco-marafiq-relay-panel.jpg.asset.json";
const telcoMarafiqRelayImg = telcoMarafiqRelayImg__ptr.url;
import telcoCableLayingTrenchImg__ptr from "@/assets/telco-cable-laying-trench.jpg.asset.json";
const telcoCableLayingTrenchImg = telcoCableLayingTrenchImg__ptr.url;
import telcoCableLayingRouteImg__ptr from "@/assets/telco-cable-laying-route.jpg.asset.json";
const telcoCableLayingRouteImg = telcoCableLayingRouteImg__ptr.url;
import telcoCableEntryDuctImg__ptr from "@/assets/telco-cable-entry-duct.jpg.asset.json";
const telcoCableEntryDuctImg = telcoCableEntryDuctImg__ptr.url;
import telcoCableTrayRunImg__ptr from "@/assets/telco-cable-tray-run.jpg.asset.json";
const telcoCableTrayRunImg = telcoCableTrayRunImg__ptr.url;
import telcoCableTrayInstallImg__ptr from "@/assets/telco-cable-tray-install.jpg.asset.json";
const telcoCableTrayInstallImg = telcoCableTrayInstallImg__ptr.url;
import telcoTrayCoverFittingImg__ptr from "@/assets/telco-tray-cover-fitting.jpg.asset.json";
const telcoTrayCoverFittingImg = telcoTrayCoverFittingImg__ptr.url;
import telcoTrayCoverCompleteImg__ptr from "@/assets/telco-tray-cover-complete.jpg.asset.json";
const telcoTrayCoverCompleteImg = telcoTrayCoverCompleteImg__ptr.url;

import pipelineImg__ptr from "@/assets/pipeline.jpg.asset.json";
const pipelineImg = pipelineImg__ptr.url;
import fabricationImg__ptr from "@/assets/fabrication.jpg.asset.json";
const fabricationImg = fabricationImg__ptr.url;
import fabrication2Img__ptr from "@/assets/fabrication2.jpg.asset.json";
const fabrication2Img = fabrication2Img__ptr.url;
import rusaylCableRouteImg__ptr from "@/assets/rusayl-132kv-cable-route.jpg.asset.json";
const rusaylCableRouteImg = rusaylCableRouteImg__ptr.url;
import rusaylSubstationLayoutImg__ptr from "@/assets/rusayl-220-132kv-substation-layout.jpg.asset.json";
const rusaylSubstationLayoutImg = rusaylSubstationLayoutImg__ptr.url;
import supremeCourtImg__ptr from "@/assets/tcc-supreme-court-complex.jpg.asset.json";
const supremeCourtImg = supremeCourtImg__ptr.url;
import tccJotunConstructionImg__ptr from "@/assets/tcc-jotun-factory-construction.jpg.asset.json";
const tccJotunConstructionImg = tccJotunConstructionImg__ptr.url;
import tccJotunEntranceImg__ptr from "@/assets/tcc-jotun-factory-entrance.jpg.asset.json";
const tccJotunEntranceImg = tccJotunEntranceImg__ptr.url;
import tccJotunAerialImg__ptr from "@/assets/tcc-jotun-factory-aerial.jpg.asset.json";
const tccJotunAerialImg = tccJotunAerialImg__ptr.url;
import tccValeAerialImg__ptr from "@/assets/tcc-vale-pelletising-aerial.jpg.asset.json";
const tccValeAerialImg = tccValeAerialImg__ptr.url;
import tccValeInteriorImg__ptr from "@/assets/tcc-vale-pelletising-interior.jpg.asset.json";
const tccValeInteriorImg = tccValeInteriorImg__ptr.url;
import tccValePlantImg__ptr from "@/assets/tcc-vale-pelletising-plant.jpg.asset.json";
const tccValePlantImg = tccValePlantImg__ptr.url;
import tccSandanImg__ptr from "@/assets/tcc-sandan-industrial-city.jpg.asset.json";
const tccSandanImg = tccSandanImg__ptr.url;

import waterPlantImg__ptr from "@/assets/water-plant.jpg.asset.json";
const waterPlantImg = waterPlantImg__ptr.url;
import refineryImg__ptr from "@/assets/refinery.jpg.asset.json";
const refineryImg = refineryImg__ptr.url;
import mudhaibiWaterImg__ptr from "@/assets/mudhaibi-water.jpg.asset.json";
const mudhaibiWaterImg = mudhaibiWaterImg__ptr.url;
import careersImg__ptr from "@/assets/careers.jpg.asset.json";
const careersImg = careersImg__ptr.url;
import balajiImg__ptr from "@/assets/balaji.jpg.asset.json";
const balajiImg = balajiImg__ptr.url;

/* Project photography (local files bundled with the repo). */
import liwaTownshipImg__ptr from "@/assets/liwa-township.jpg.asset.json";
const liwaTownshipImg = liwaTownshipImg__ptr.url;
import liwaIrrigationImg__ptr from "@/assets/liwa-irrigation.jpg.asset.json";
const liwaIrrigationImg = liwaIrrigationImg__ptr.url;
import liwaPumpStationImg__ptr from "@/assets/liwa-pump-station.jpg.asset.json";
const liwaPumpStationImg = liwaPumpStationImg__ptr.url;
import liwaReservoirImg__ptr from "@/assets/liwa-reservoir.jpg.asset.json";
const liwaReservoirImg = liwaReservoirImg__ptr.url;
import liwaLiftStationImg__ptr from "@/assets/liwa-lift-station.jpg.asset.json";
const liwaLiftStationImg = liwaLiftStationImg__ptr.url;
import liwaPipeline1Img__ptr from "@/assets/liwa-pipeline-1.jpg.asset.json";
const liwaPipeline1Img = liwaPipeline1Img__ptr.url;
import liwaPipeline2Img__ptr from "@/assets/liwa-pipeline-2.jpg.asset.json";
const liwaPipeline2Img = liwaPipeline2Img__ptr.url;
import liwaChambersImg__ptr from "@/assets/liwa-chambers.jpg.asset.json";
const liwaChambersImg = liwaChambersImg__ptr.url;
import mudhaibiTeamImg__ptr from "@/assets/mudhaibi-team.jpg.asset.json";
const mudhaibiTeamImg = mudhaibiTeamImg__ptr.url;
import mudhaibiWorksImg__ptr from "@/assets/mudhaibi-works.jpg.asset.json";
const mudhaibiWorksImg = mudhaibiWorksImg__ptr.url;
import bidbidPourImg__ptr from "@/assets/bidbid-pour.jpg.asset.json";
const bidbidPourImg = bidbidPourImg__ptr.url;
import bidbidQuarryImg__ptr from "@/assets/bidbid-quarry.jpg.asset.json";
const bidbidQuarryImg = bidbidQuarryImg__ptr.url;
import bidbidRoadsideImg__ptr from "@/assets/bidbid-roadside.jpg.asset.json";
const bidbidRoadsideImg = bidbidRoadsideImg__ptr.url;
import bidbidFormworkImg__ptr from "@/assets/bidbid-formwork.jpg.asset.json";
const bidbidFormworkImg = bidbidFormworkImg__ptr.url;
import bidbidPumpImg__ptr from "@/assets/bidbid-pump.jpg.asset.json";
const bidbidPumpImg = bidbidPumpImg__ptr.url;
import soharPiperackImg__ptr from "@/assets/sohar-piperack.jpg.asset.json";
const soharPiperackImg = soharPiperackImg__ptr.url;
import soharPipingImg__ptr from "@/assets/sohar-piping.jpg.asset.json";
const soharPipingImg = soharPipingImg__ptr.url;
import soharPlantImg__ptr from "@/assets/sohar-plant.jpg.asset.json";
const soharPlantImg = soharPlantImg__ptr.url;
import soharFoundationsImg__ptr from "@/assets/sohar-foundations.jpg.asset.json";
const soharFoundationsImg = soharFoundationsImg__ptr.url;
import soharTankPadsImg__ptr from "@/assets/sohar-tankpads.jpg.asset.json";
const soharTankPadsImg = soharTankPadsImg__ptr.url;
import soharScaffoldImg__ptr from "@/assets/sohar-scaffold.jpg.asset.json";
const soharScaffoldImg = soharScaffoldImg__ptr.url;
import soharSteelImg__ptr from "@/assets/sohar-steel.jpg.asset.json";
const soharSteelImg = soharSteelImg__ptr.url;
...
import teilCokeHeroImg__ptr from "@/assets/teil-coke-feeding-hero.jpg.asset.json";
const teilCokeHeroImg = teilCokeHeroImg__ptr.url;
import teilCokeErectionImg__ptr from "@/assets/teil-coke-feeding-erection.jpg.asset.json";
const teilCokeErectionImg = teilCokeErectionImg__ptr.url;
import teilCokeConveyorImg__ptr from "@/assets/teil-coke-feeding-conveyor.jpg.asset.json";
const teilCokeConveyorImg = teilCokeConveyorImg__ptr.url;
import teilDcplHeroImg__ptr from "@/assets/teil-dcpl-hero.jpg.asset.json";
const teilDcplHeroImg = teilDcplHeroImg__ptr.url;
import teilDcplErectionImg__ptr from "@/assets/teil-dcpl-erection.jpg.asset.json";
const teilDcplErectionImg = teilDcplErectionImg__ptr.url;
import teilDcplStructuresImg__ptr from "@/assets/teil-dcpl-structures.jpg.asset.json";
const teilDcplStructuresImg = teilDcplStructuresImg__ptr.url;
import teilWarehouseHeroImg__ptr from "@/assets/teil-warehouse-hero.jpg.asset.json";
const teilWarehouseHeroImg = teilWarehouseHeroImg__ptr.url;
import teilWarehouseErectionImg__ptr from "@/assets/teil-warehouse-erection.jpg.asset.json";
const teilWarehouseErectionImg = teilWarehouseErectionImg__ptr.url;
import teilWarehouseCompleteImg__ptr from "@/assets/teil-warehouse-complete.jpg.asset.json";
const teilWarehouseCompleteImg = teilWarehouseCompleteImg__ptr.url;
import teilSilosHeroImg__ptr from "@/assets/teil-silos-hero.jpg.asset.json";
const teilSilosHeroImg = teilSilosHeroImg__ptr.url;
import teilSilosConeImg__ptr from "@/assets/teil-silos-cone.jpg.asset.json";
const teilSilosConeImg = teilSilosConeImg__ptr.url;
