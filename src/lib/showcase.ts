...
import smelterHeroDomesSrcAsset from "@/assets/smelter-hero-domes.jpg.asset.json";
const smelterHeroDomesAsset = { url: smelterHeroDomesSrc };
import smelterDomeLiftSrcAsset from "@/assets/smelter-dome-lift.jpg.asset.json";
const smelterDomeLiftAsset = { url: smelterDomeLiftSrc };
import tankDomesAerialSrcAsset from "@/assets/tank-domes-aerial.jpg.asset.json";
const tankDomesAerialAsset = { url: tankDomesAerialSrc };
import valeASrcAsset from "@/assets/vale-a.jpg.asset.json";
const valeAAsset = { url: valeASrc };
import valeBSrcAsset from "@/assets/vale-b.jpg.asset.json";
const valeBAsset = { url: valeBSrc };
import valeCSrcAsset from "@/assets/vale-c.jpg.asset.json";
const valeCAsset = { url: valeCSrc };
import valeFSrcAsset from "@/assets/vale-f.jpg.asset.json";
const valeFAsset = { url: valeFSrc };
import yibalKilnSrcAsset from "@/assets/yibal-kiln.jpg.asset.json";
const yibalKilnAsset = { url: yibalKilnSrc };
import barkaRack1SrcAsset from "@/assets/barka-swro-rack1.jpg.asset.json";
const barkaRack1Asset = { url: barkaRack1Src };
import barkaRack2SrcAsset from "@/assets/barka-swro-rack2.jpg.asset.json";
const barkaRack2Asset = { url: barkaRack2Src };
import barkaRack3SrcAsset from "@/assets/barka-swro-rack3.jpg.asset.json";
const barkaRack3Asset = { url: barkaRack3Src };
import duqmEpc1ProcessImgAsset from "@/assets/duqm-epc1-process-units.jpg.asset.json";
import duqmEpc1SteelImgAsset from "@/assets/duqm-epc1-steel-structure.jpg.asset.json";
import duqmEpc1PiperackImgAsset from "@/assets/duqm-epc1-piperack.jpg.asset.json";
import duqmEpc1PiperackWideImgAsset from "@/assets/duqm-epc1-piperack-wide.jpg.asset.json";
import duqmEpc1SwitchgearImgAsset from "@/assets/duqm-epc1-switchgear.jpg.asset.json";
import duqmEpc2OffsitesImgAsset from "@/assets/duqm-epc2-offsites.jpg.asset.json";
import duqmEpc2DerrickImgAsset from "@/assets/duqm-epc2-derrick.jpg.asset.json";
import duqmEpc2BulletLiftImgAsset from "@/assets/duqm-epc2-bullet-lift.jpg.asset.json";
import duqmEpc2BulletTransportImgAsset from "@/assets/duqm-epc2-bullet-transport.jpg.asset.json";
import duqmEpc2PiperackRoadImgAsset from "@/assets/duqm-epc2-piperack-road.jpg.asset.json";
import duqmEpc2SwitchgearImgAsset from "@/assets/duqm-epc2-switchgear.jpg.asset.json";
import telcoNedcBuildingImgAsset from "@/assets/telco-nedc-substation-building.jpg.asset.json";
import telcoNedcTransformerBayImgAsset from "@/assets/telco-nedc-transformer-bay.jpg.asset.json";
import telcoNedc33kvImgAsset from "@/assets/telco-nedc-33kv-switchgear.jpg.asset.json";
import telcoNedc11kvImgAsset from "@/assets/telco-nedc-11kv-switchgear.jpg.asset.json";
import telcoNedcRelayPanelsImgAsset from "@/assets/telco-nedc-control-relay-panels.jpg.asset.json";
import telcoNedcBatteryImgAsset from "@/assets/telco-nedc-battery-bank.jpg.asset.json";
import telcoMarafiqLiftImgAsset from "@/assets/telco-marafiq-transformer-lift.jpg.asset.json";
import telcoMarafiqDeliveryImgAsset from "@/assets/telco-marafiq-transformer-delivery.jpg.asset.json";
import telcoMarafiqGlandingImgAsset from "@/assets/telco-marafiq-cable-glanding.jpg.asset.json";
import telcoMarafiqRelayImgAsset from "@/assets/telco-marafiq-relay-panel.jpg.asset.json";
import telcoCableLayingTrenchImgAsset from "@/assets/telco-cable-laying-trench.jpg.asset.json";
import telcoCableLayingRouteImgAsset from "@/assets/telco-cable-laying-route.jpg.asset.json";
import telcoCableEntryDuctImgAsset from "@/assets/telco-cable-entry-duct.jpg.asset.json";
import telcoCableTrayRunImgAsset from "@/assets/telco-cable-tray-run.jpg.asset.json";
import telcoCableTrayInstallImgAsset from "@/assets/telco-cable-tray-install.jpg.asset.json";
import telcoTrayCoverFittingImgAsset from "@/assets/telco-tray-cover-fitting.jpg.asset.json";
import telcoTrayCoverCompleteImgAsset from "@/assets/telco-tray-cover-complete.jpg.asset.json";

import pipelineImgAsset from "@/assets/pipeline.jpg.asset.json";
import fabricationImgAsset from "@/assets/fabrication.jpg.asset.json";
import fabrication2ImgAsset from "@/assets/fabrication2.jpg.asset.json";
import rusaylCableRouteImgAsset from "@/assets/rusayl-132kv-cable-route.jpg.asset.json";
import rusaylSubstationLayoutImgAsset from "@/assets/rusayl-220-132kv-substation-layout.jpg.asset.json";
import supremeCourtImgAsset from "@/assets/tcc-supreme-court-complex.jpg.asset.json";
import tccJotunConstructionImgAsset from "@/assets/tcc-jotun-factory-construction.jpg.asset.json";
import tccJotunEntranceImgAsset from "@/assets/tcc-jotun-factory-entrance.jpg.asset.json";
import tccJotunAerialImgAsset from "@/assets/tcc-jotun-factory-aerial.jpg.asset.json";
import tccValeAerialImgAsset from "@/assets/tcc-vale-pelletising-aerial.jpg.asset.json";
import tccValeInteriorImgAsset from "@/assets/tcc-vale-pelletising-interior.jpg.asset.json";
import tccValePlantImgAsset from "@/assets/tcc-vale-pelletising-plant.jpg.asset.json";
import tccSandanImgAsset from "@/assets/tcc-sandan-industrial-city.jpg.asset.json";

import waterPlantImgAsset from "@/assets/water-plant.jpg.asset.json";
import refineryImgAsset from "@/assets/refinery.jpg.asset.json";
import mudhaibiWaterImgAsset from "@/assets/mudhaibi-water.jpg.asset.json";
import careersImgAsset from "@/assets/careers.jpg.asset.json";
import balajiImgAsset from "@/assets/balaji.jpg.asset.json";

/* Project photography (local files bundled with the repo). */
import liwaTownshipImgAsset from "@/assets/liwa-township.jpg.asset.json";
import liwaIrrigationImgAsset from "@/assets/liwa-irrigation.jpg.asset.json";
import liwaPumpStationImgAsset from "@/assets/liwa-pump-station.jpg.asset.json";
import liwaReservoirImgAsset from "@/assets/liwa-reservoir.jpg.asset.json";
import liwaLiftStationImgAsset from "@/assets/liwa-lift-station.jpg.asset.json";
import liwaPipeline1ImgAsset from "@/assets/liwa-pipeline-1.jpg.asset.json";
import liwaPipeline2ImgAsset from "@/assets/liwa-pipeline-2.jpg.asset.json";
import liwaChambersImgAsset from "@/assets/liwa-chambers.jpg.asset.json";
import mudhaibiTeamImgAsset from "@/assets/mudhaibi-team.jpg.asset.json";
import mudhaibiWorksImgAsset from "@/assets/mudhaibi-works.jpg.asset.json";
import bidbidPourImgAsset from "@/assets/bidbid-pour.jpg.asset.json";
import bidbidQuarryImgAsset from "@/assets/bidbid-quarry.jpg.asset.json";
import bidbidRoadsideImgAsset from "@/assets/bidbid-roadside.jpg.asset.json";
import bidbidFormworkImgAsset from "@/assets/bidbid-formwork.jpg.asset.json";
import bidbidPumpImgAsset from "@/assets/bidbid-pump.jpg.asset.json";
import soharPiperackImgAsset from "@/assets/sohar-piperack.jpg.asset.json";
import soharPipingImgAsset from "@/assets/sohar-piping.jpg.asset.json";
import soharPlantImgAsset from "@/assets/sohar-plant.jpg.asset.json";
import soharFoundationsImgAsset from "@/assets/sohar-foundations.jpg.asset.json";
import soharTankPadsImgAsset from "@/assets/sohar-tankpads.jpg.asset.json";
import soharScaffoldImgAsset from "@/assets/sohar-scaffold.jpg.asset.json";
import soharSteelImgAsset from "@/assets/sohar-steel.jpg.asset.json";
...
import teilCokeHeroImgAsset from "@/assets/teil-coke-feeding-hero.jpg.asset.json";
import teilCokeErectionImgAsset from "@/assets/teil-coke-feeding-erection.jpg.asset.json";
import teilCokeConveyorImgAsset from "@/assets/teil-coke-feeding-conveyor.jpg.asset.json";
import teilDcplHeroImgAsset from "@/assets/teil-dcpl-hero.jpg.asset.json";
import teilDcplErectionImgAsset from "@/assets/teil-dcpl-erection.jpg.asset.json";
import teilDcplStructuresImgAsset from "@/assets/teil-dcpl-structures.jpg.asset.json";
import teilWarehouseHeroImgAsset from "@/assets/teil-warehouse-hero.jpg.asset.json";
import teilWarehouseErectionImgAsset from "@/assets/teil-warehouse-erection.jpg.asset.json";
import teilWarehouseCompleteImgAsset from "@/assets/teil-warehouse-complete.jpg.asset.json";
import teilSilosHeroImgAsset from "@/assets/teil-silos-hero.jpg.asset.json";
import teilSilosConeImgAsset from "@/assets/teil-silos-cone.jpg.asset.json";

const smelterHeroDomesSrc = smelterHeroDomesSrcAsset.url;
const smelterDomeLiftSrc = smelterDomeLiftSrcAsset.url;
const tankDomesAerialSrc = tankDomesAerialSrcAsset.url;
const valeASrc = valeASrcAsset.url;
const valeBSrc = valeBSrcAsset.url;
const valeCSrc = valeCSrcAsset.url;
const valeFSrc = valeFSrcAsset.url;
const yibalKilnSrc = yibalKilnSrcAsset.url;
const barkaRack1Src = barkaRack1SrcAsset.url;
const barkaRack2Src = barkaRack2SrcAsset.url;
const barkaRack3Src = barkaRack3SrcAsset.url;
const duqmEpc1ProcessImg = duqmEpc1ProcessImgAsset.url;
const duqmEpc1SteelImg = duqmEpc1SteelImgAsset.url;
const duqmEpc1PiperackImg = duqmEpc1PiperackImgAsset.url;
const duqmEpc1PiperackWideImg = duqmEpc1PiperackWideImgAsset.url;
const duqmEpc1SwitchgearImg = duqmEpc1SwitchgearImgAsset.url;
const duqmEpc2OffsitesImg = duqmEpc2OffsitesImgAsset.url;
const duqmEpc2DerrickImg = duqmEpc2DerrickImgAsset.url;
const duqmEpc2BulletLiftImg = duqmEpc2BulletLiftImgAsset.url;
const duqmEpc2BulletTransportImg = duqmEpc2BulletTransportImgAsset.url;
const duqmEpc2PiperackRoadImg = duqmEpc2PiperackRoadImgAsset.url;
const duqmEpc2SwitchgearImg = duqmEpc2SwitchgearImgAsset.url;
const telcoNedcBuildingImg = telcoNedcBuildingImgAsset.url;
const telcoNedcTransformerBayImg = telcoNedcTransformerBayImgAsset.url;
const telcoNedc33kvImg = telcoNedc33kvImgAsset.url;
const telcoNedc11kvImg = telcoNedc11kvImgAsset.url;
const telcoNedcRelayPanelsImg = telcoNedcRelayPanelsImgAsset.url;
const telcoNedcBatteryImg = telcoNedcBatteryImgAsset.url;
const telcoMarafiqLiftImg = telcoMarafiqLiftImgAsset.url;
const telcoMarafiqDeliveryImg = telcoMarafiqDeliveryImgAsset.url;
const telcoMarafiqGlandingImg = telcoMarafiqGlandingImgAsset.url;
const telcoMarafiqRelayImg = telcoMarafiqRelayImgAsset.url;
const telcoCableLayingTrenchImg = telcoCableLayingTrenchImgAsset.url;
const telcoCableLayingRouteImg = telcoCableLayingRouteImgAsset.url;
const telcoCableEntryDuctImg = telcoCableEntryDuctImgAsset.url;
const telcoCableTrayRunImg = telcoCableTrayRunImgAsset.url;
const telcoCableTrayInstallImg = telcoCableTrayInstallImgAsset.url;
const telcoTrayCoverFittingImg = telcoTrayCoverFittingImgAsset.url;
const telcoTrayCoverCompleteImg = telcoTrayCoverCompleteImgAsset.url;
const pipelineImg = pipelineImgAsset.url;
const fabricationImg = fabricationImgAsset.url;
const fabrication2Img = fabrication2ImgAsset.url;
const rusaylCableRouteImg = rusaylCableRouteImgAsset.url;
const rusaylSubstationLayoutImg = rusaylSubstationLayoutImgAsset.url;
const supremeCourtImg = supremeCourtImgAsset.url;
const tccJotunConstructionImg = tccJotunConstructionImgAsset.url;
const tccJotunEntranceImg = tccJotunEntranceImgAsset.url;
const tccJotunAerialImg = tccJotunAerialImgAsset.url;
const tccValeAerialImg = tccValeAerialImgAsset.url;
const tccValeInteriorImg = tccValeInteriorImgAsset.url;
const tccValePlantImg = tccValePlantImgAsset.url;
const tccSandanImg = tccSandanImgAsset.url;
const waterPlantImg = waterPlantImgAsset.url;
const refineryImg = refineryImgAsset.url;
const mudhaibiWaterImg = mudhaibiWaterImgAsset.url;
const careersImg = careersImgAsset.url;
const balajiImg = balajiImgAsset.url;
const liwaTownshipImg = liwaTownshipImgAsset.url;
const liwaIrrigationImg = liwaIrrigationImgAsset.url;
const liwaPumpStationImg = liwaPumpStationImgAsset.url;
const liwaReservoirImg = liwaReservoirImgAsset.url;
const liwaLiftStationImg = liwaLiftStationImgAsset.url;
const liwaPipeline1Img = liwaPipeline1ImgAsset.url;
const liwaPipeline2Img = liwaPipeline2ImgAsset.url;
const liwaChambersImg = liwaChambersImgAsset.url;
const mudhaibiTeamImg = mudhaibiTeamImgAsset.url;
const mudhaibiWorksImg = mudhaibiWorksImgAsset.url;
const bidbidPourImg = bidbidPourImgAsset.url;
const bidbidQuarryImg = bidbidQuarryImgAsset.url;
const bidbidRoadsideImg = bidbidRoadsideImgAsset.url;
const bidbidFormworkImg = bidbidFormworkImgAsset.url;
const bidbidPumpImg = bidbidPumpImgAsset.url;
const soharPiperackImg = soharPiperackImgAsset.url;
const soharPipingImg = soharPipingImgAsset.url;
const soharPlantImg = soharPlantImgAsset.url;
const soharFoundationsImg = soharFoundationsImgAsset.url;
const soharTankPadsImg = soharTankPadsImgAsset.url;
const soharScaffoldImg = soharScaffoldImgAsset.url;
const soharSteelImg = soharSteelImgAsset.url;
const teilCokeHeroImg = teilCokeHeroImgAsset.url;
const teilCokeErectionImg = teilCokeErectionImgAsset.url;
const teilCokeConveyorImg = teilCokeConveyorImgAsset.url;
const teilDcplHeroImg = teilDcplHeroImgAsset.url;
const teilDcplErectionImg = teilDcplErectionImgAsset.url;
const teilDcplStructuresImg = teilDcplStructuresImgAsset.url;
const teilWarehouseHeroImg = teilWarehouseHeroImgAsset.url;
const teilWarehouseErectionImg = teilWarehouseErectionImgAsset.url;
const teilWarehouseCompleteImg = teilWarehouseCompleteImgAsset.url;
const teilSilosHeroImg = teilSilosHeroImgAsset.url;
const teilSilosConeImg = teilSilosConeImgAsset.url;
